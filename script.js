...
serviceBtns.forEach(btn => {
    btn.addEventListener('click', () => {
        ...
        if (tg) {
            tg.openTelegramLink(`https://t.me/moldenov?text=Здравствуйте! Интересует услуга: ${serviceName}`);
        } else {
            window.open(`https://t.me/moldenov?text=Здравствуйте! Интересует услуга: ${serviceName}`, '_blank');
        }
    });
});
